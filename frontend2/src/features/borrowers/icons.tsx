/**
 * Local inline icons for Phase 59 borrowers UI.
 *
 * Mirrors `src/features/taxonomy/icons.tsx` — no `lucide-react` dependency
 * (forbidden by v2.0 no-new-runtime-deps lock). Adds two borrower-specific
 * icons: Trash2 (hard-delete) and ArrowLeft (detail-page back link).
 */
