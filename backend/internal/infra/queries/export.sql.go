...
SELECT a.id, a.item_id, a.file_id, a.attachment_type, a.title, a.is_primary, a.external_doc_id, a.created_at, a.updated_at, a.workspace_id, a.dms_type FROM warehouse.attachments a
