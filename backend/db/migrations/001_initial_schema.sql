...
-- ============================================================================
-- Home Warehouse System - Initial Schema (consolidated)
-- ============================================================================
-- Consolidated 2026-06-11 from migrations 001-006 while the production
-- database was still empty. Generated from the dbmate schema dump of a
-- fully migrated database, with backfill DML dropped (nothing to backfill
-- on a fresh install). History folded in:
--   001 initial schema
--   002 tenant scoping columns (attachments/item_labels/container_tags)
--   003 housekeeping (NOT NULL booleans, CHECKs, index diet, uuidv7)
--   004 integrity hardening (citext emails, unique barcodes/tokens,
--       user-deletion FK fixes, loan FOR UPDATE trigger, cycle guards)
--   005 composite-FK tenancy (cross-tenant references impossible)
--   006 pending_changes idempotency + optimistic concurrency
-- ============================================================================
