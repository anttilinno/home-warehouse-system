...
must_haves:
  truths:
    - "repairphoto handlers have unit tests covering CRUD operations"
    - "declutter handlers have unit tests covering list, counts, and mark-used"
    - "Error paths return correct HTTP status codes"
    - "Event publishing is tested with nil broadcaster safety"
  artifacts:
