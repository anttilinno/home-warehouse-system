...
- [x] 11-03-PLAN.md — hooks: useScanResolve (single funnel + 4-state banner), useScanFeedback, useTorch, useScanHistory
- [x] 11-04-PLAN.md — camera components: BarcodeScanner (prop-driven pause), ScanViewfinderOverlay, ScanTorchToggle
