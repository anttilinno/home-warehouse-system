...
import { InventoryWhereFields } from "./components/InventoryWhereFields";
import { InventoryDateFields } from "./components/InventoryDateFields";
    ...
    <div className="mx-auto max-w-[560px]">
      <Window title={titleText} titlebarVariant="blue">
        ...
        >
          ...
          <InventoryDateFields register={register} errors={errors} />
