...
export function SocialLogin() {
  ...
  // Avoid SSR hydration mismatch: server always renders enabled,
  // client only disables after mount when offline is detected
  useEffect(() => {
    setMounted(true);
  }, []);
  ...
  const handleOAuthLogin = useCallback((provider: "google" | "github") => {
    // Preserve returnTo URL across the OAuth redirect chain via sessionStorage
